...
snapshot_dir="$root_dir/test/e2e/migration/fixtures/snapshots/$E2E_PACKAGE"
...
kubectl apply --validate=false -f "$root_dir/test/e2e/migration/fixtures/operatorhubio-catalogsource.yaml"
